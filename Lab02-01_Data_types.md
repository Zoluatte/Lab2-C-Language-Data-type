...
ค่า floatจะให้ค่าจุดทศนิยมที่น้อยกว่า double

3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?

กรณีที่ต้องการค่าตัวเลขที่แม่นยำเชิงลึกมากๆ เพราะค่าdoubleสามารถให้ค่าทศนิยมที่มากกว่าfloat
...
ค่าตัวเลข ASCII เป็นการแทนอักขระด้วยตัวเลขที่คอมพิวเตอร์เข้าใจได้เนื่องจากคอมพิวเตอร์ไม่เข้าใจตัวอักษรโดยตรงจึงต้องใช้ตัวเลขในการแทน
...
นักเขียนโปรแกรมไม่สามารถกำหนดรหัส ASCII เองได้เพราะมันเป็นมาตรฐานสากลที่ถูกกำหนดและกำกับโดยองค์กรมาตรฐาน
...
- เมื่อ myByte ถูกกำหนดให้เป็น 256 ผลลัพธ์ที่ได้คืออะไร และเพราะเหตุใด?
  ...
  ผลลัพธ์ที่ได้คือ 0 เพราะเกินขอบเขตของค่า(data overflow)
