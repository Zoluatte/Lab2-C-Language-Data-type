...
เมื่อมี float หรือ double เข้ามาเกี่ยวข้องผลลัพธ์จะเป็นค่าทศนิยม
เมื่อทุกตัวเป็น int ผลลัพธ์จะเป็นจำนวนเต็ม
...
- ในการเขียนโปรแกรม ต้องทำ Type Casting ในสถานการณ์ใดบ้าง
  ...
  ป้องกันการหารผิดพลาดหรือข้อมูลสูญหาย

  สื่อความหมายว่าเราต้องการแปลงข้อมูลอย่างเจตนา

  ใช้ร่วมกับระบบที่ต้องการชนิดข้อมูลเฉพาะเจาะจง
